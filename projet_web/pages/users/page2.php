...
<html lang="en">
  ...
  <?php
    ...
    <div class="hold">
      ...
      <label for="certificateInput" class="custom-button"
        >Choose Your Certificate</label
      >
      <input
        type="file"
        id="certificateInput"
      ...
      <script>
        ...
        function addCertificate() {
          var input = document.getElementById("certificateInput");

          if (input.files && input.files[0]) {
            var reader = new FileReader();

            reader.onload = function (e) {
              savedCertificateData = e.target.result;
        ...
        function nextPage() {
          if (!savedImageData || !savedCardData || !savedCertificateData) {
            alert(
              "Please choose both an image, a card, and a certificate before proceeding."
            );
          } else {
